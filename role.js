  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (getRole() !== 'driver') {
      ...
      if (!document.getElementById('cl-drv-cta')) {
        ...
        cta.id = 'cl-drv-cta';
        cta.style.cssText = 'background:var(--card);border:1px solid var(--border);border-radius:14px;padding:24px;text-align:center;margin-bottom:12px;';
        cta.innerHTML =
          '<div style="font-size:48px;margin-bottom:12px;">🚖</div>' +
          '<div style="font-size:15px;font-weight:700;margin-bottom:8px;color:var(--text);">Want to earn as a driver?</div>' +
          '<div style="font-size:12px;color:var(--muted);margin-bottom:16px;">Register to receive ride requests and earn 1 THB per trip.</div>' +
